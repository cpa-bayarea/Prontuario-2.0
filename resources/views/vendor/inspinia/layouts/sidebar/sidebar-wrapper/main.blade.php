<div class="sidebar-collapse">
        ...
        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
          <span class="clear">
            <span class="block m-t-xs">
              <strong class="font-bold">@yield('user-name', auth()->user()->name)</strong>
            </span>
            <span class="text-muted text-xs block">@yield('user-text', auth()->user()->email)<b class="caret"></b></span>
          </span>
        </a>
  ...
  <ul class="nav metismenu" id="side-menu" style="padding-left:0px;">
    <li class="">
      <a href="#">
        <i class="fa fa-files-o"></i> <span class="nav-label">Other Pages</span><span class="fa arrow"></span></a>
