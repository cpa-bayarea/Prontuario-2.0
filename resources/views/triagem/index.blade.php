            ...
            <form action="triagem" method="POST" id="form_triagem">
                ...
                <div class="form-group row"><label for="supervisor" class="col-lg-2 col-form-label">Grupo</label>
                    <div class="col-sm-10">
                        ...
                        <div class="checkbox-inline i-checks"><label> <div class="iradio_square-green" style="position: relative;"><input requiredtype="radio" value="Educação Drogadição" name="grupo" style="position: absolute; opacity: 0;"><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div> <i></i> Educação Drogadição </label></div>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group row"><label for="supervisor" class="col-lg-2 col-form-label">Temporário</label>
                    <div class="col-sm-10">
                        ...
                        <div class="checkbox-inline i-checks" id="minhaDiv" style="display: none;"><textarea rows="5" cols="50" required></textarea></div>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
