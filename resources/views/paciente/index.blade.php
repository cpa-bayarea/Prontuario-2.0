                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="text-center">
                                            <button type="button findById" class="btn btn-sm btn-w-m btn-success findById" value="{{$paciente->id}}" type="button" data-toggle="modal" data-target="#modalTelefone">
                                                Visualizar Telefone</button>
